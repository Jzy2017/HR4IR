...
class Inveritible_Decolorization(nn.Module):
    def __init__(self, dims_in=[[3, 64, 64]], down_num=3, block_num=[4, 4, 6],is_train=True):
    # def __init__(self, dims_in=[[3, 64, 64]], down_num=3, block_num=[6, 6, 6]):
